    ...
    <section id="experience" className="experience">
      ...
      <div className="job-card">
        ...
        <ul>
          ...
          <li>Spearheaded training and mentorship for new team members, accelerating onboarding time by 20% and ensuring rapid understanding of product analysis.</li>
          <li>Analysed complex client data to create insightful, summarized reports and dashboards used by management for strategic decision-making.</li>
        </ul>
      </div>
    </section>
  );
